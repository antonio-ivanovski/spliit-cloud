...
- Expense-file and group import categorization are deferred. The eventual import experience should reuse the reviewed Tools workflow, potentially scoped to imported expense IDs.
