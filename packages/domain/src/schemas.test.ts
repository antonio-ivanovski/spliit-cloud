...
const baseApi = {
  expenseDate: new Date('2025-01-01T00:00:00.000Z'),
  expenseAt: new Date('2025-01-01T12:00:00.000Z'),
  expenseTimeZone: 'UTC',
  title: 'Dinner',
  category: 'general',
  amount: 1000,
...
describe('expenseFormInputSchema', () => {
  ...
  it('rejects malformed and nonexistent wall times', () => {
    expect(
    ...
    expect(
      expenseFormInputSchema.safeParse({
        ...baseInput,
        expenseDate: new Date('2026-03-29T00:00:00.000Z'),
        expenseTime: '02:30',
...
describe('expenseApiSchema', () => {
  ...
  it('requires an expense instant and timezone', () => {
    expect(
      expenseApiSchema.safeParse({ ...baseApi, expenseAt: undefined }).success,
    ).toBe(false)
    expect(
