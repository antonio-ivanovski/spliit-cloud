# de-DE translation guide

Apply `default.md` first, then these German (Germany) rules.

- Use standard German for Germany and a friendly `du`/impersonal UI voice; do not switch unpredictably to `Sie`.
- Capitalize nouns correctly and keep compound terms readable. Prefer a short natural compound over a long English-shaped phrase.
