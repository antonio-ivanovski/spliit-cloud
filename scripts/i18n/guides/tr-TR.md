# tr-TR translation guide

Apply `default.md` first, then these Turkish (Türkiye) rules.

- Use standard contemporary Turkish with a neutral, friendly UI voice. Prefer impersonal phrasing when direct `siz` address would feel stiff.
