...
- [ ] 13.18 Web test: section-level "Create expense" buttons on the homepage open scope-picker dialogs — the Groups section button opens a dialog listing only groups, the Friends section button opens a dialog listing only friend ledgers; selecting an item navigates to the create-expense form.
