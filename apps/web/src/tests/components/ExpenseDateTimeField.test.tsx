...
function Harness({
  ...
  const selectedDate = values.expenseDate
    ? values.expenseDate.toISOString().slice(0, 10)
    : ''
...
describe('buildExpenseTimeTimeline', () => {
  ...
  it('keeps wall-clock labels stable in non-UTC zones and omits DST gaps', () => {
    const ordinary = buildExpenseTimeTimeline(
      { dateIso: '2026-03-28', time: '12:07' },
      'Europe/Skopje',
    )
