...
export function DomainSwapCard({ title, description }: DomainSwapCardProps) {
  return (
    <Card className="relative overflow-hidden border-primary/30 bg-gradient-to-br from-primary/[0.08] via-background to-background shadow-[0_1px_0_0_hsl(var(--primary)/0.1)]">
      <div
        aria-hidden
