 ...
 * Compares ledger amount plus original amount/currency so conversion-only edits
 * still surface when the user-facing original total moves. Display uses the
 * original currency when present.
 */
