...
/**
 * Business handlers are registered here by the owning feature. They live in the
 * API package because that is where the work they call lives; both the
 * standalone worker (apps/worker) and the API's inline job runner
 * (JOBS_INLINE=true) register the same object.
 */
