...
<img src="./assets/next/expenses-list-before.webp" alt="Expenses list before categorization" width="640">

**2. Open Tools and start categorizing.** Head to the Tools tab and hit "Categorize expenses".

<img src="./assets/next/tools-tab-categorize-expenses.webp" alt="Tools tab with the categorize expenses entry" width="640">
...
<img src="./assets/next/dictionary-history-vs-system-one-model.webp" alt="Choosing between Dictionary & history and the System One model" width="640">

**4. Calibration begins.** The first round prepares your expenses — you can leave and come back anytime; progress is saved.

<img src="./assets/next/starting-calibraton-round-1.webp" alt="Calibration round starting" width="640">
...
<img src="./assets/next/calibration-round-1.webp" alt="Confirming the first calibration round" width="640">
...
<img src="./assets/next/categorizing-expenses-first-run.webp" alt="First categorization run in progress" width="640">
...
<img src="./assets/next/review-suggestions-accept-chip-suggestion.webp" alt="Accepting a suggestion chip in the review table" width="640">

**8. Filter the leftovers.** Use the General filter to isolate expenses still without a category and handle them one by one.

<img src="./assets/next/categorization-general-filter.webp" alt="Filtering expenses still in General" width="640">
...
<img src="./assets/next/re-run-updating-suggestions-progress.webp" alt="Rerun updating the remaining suggestions" width="640">
...
<img src="./assets/next/categorization-complete-step.webp" alt="Categorization complete and ready to save" width="640">

**11. Enjoy a tidy list.** Every expense now carries its category icon — baggage fees fly, dinners dine, taxis drive.

<img src="./assets/next/expenses-list-after.webp" alt="Expenses list after categorization" width="640">
